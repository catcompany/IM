...
public class SaveMsgDao {
    ...
    private static final HashMap<Integer, TranObjectType> idTrantype = new HashMap<>();
    private static final HashMap<TranObjectType, Integer> trantypeId = new HashMap<>();
    ...
    public static ArrayList<TranObject> selectMsg(int id) {
        ...
        String sq0 = "use " + ServerDatabaseInfo.tableName;
        String sql1 = "select * " +
                "from saveMsg " +
                "where getid=?";
        Connection con = DBPool.getConnection();
