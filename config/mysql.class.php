...
class MySQL
{
    ...
    function __construct($dbHost, $dbPort, $dbUsername, $dbPassword, $dbName)
    {
        $this->dbHost = $dbHost;
        $this->dbPort = $dbPort;
    ...
    {
        $this->dbLink = mysqli_connect($host = $this->dbHost, $user = $this->dbUsername, $password = $this->dbPassword, $database = $this->dbName, $port = $this->dbPort)or die(mysqli_error());;
        if (!$this->dbLink) {
            $this->ShowError();
            return false;
