...
import com.imorning.im.types.STATUS;
...
public class XMLHandler extends DefaultHandler {
    ...
    private final Vector<FriendInfo> mFriends = new Vector<FriendInfo>();
    private final Vector<FriendInfo> mOnlineFriends = new Vector<FriendInfo>();
    private final Vector<FriendInfo> mUnapprovedFriends = new Vector<FriendInfo>();
    private final Vector<MessageInfo> mUnreadMessages = new Vector<MessageInfo>();
