...
import com.imorning.im.fragment.FriendListFragment;
import com.imorning.im.fragment.MessageFragment;
import com.imorning.im.fragment.NearByFragment;
import com.imorning.im.fragment.UserInfoFragment;
...
public class MainActivity extends FragmentActivity {
    ...
    private final OnClickListener newsOnClickListener = new OnClickListener() {
        @Override
    ...
    private final OnClickListener constactOnClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction ft = fm.beginTransaction();
    ...
    private final OnClickListener deynaimicOnClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction ft = fm.beginTransaction();
    ...
    private final OnClickListener settingOnClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction ft = fm.beginTransaction();
